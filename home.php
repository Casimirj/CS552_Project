...
if($_SESSION['usertype'] == 0){ //regular user (trainee)
    ...
    echo("
        ...
        <a class=\"homepagebutton\" href='createEnrollment.php'><div class=\"buttonimage material-icons\">accessibility</div><div class=\"buttontext\">Enroll User</div></a>
        <a class=\"homepagebutton\" href='deleteEnrollments.php'><div class=\"buttonimage material-icons\">polymer</div><div class=\"buttontext\">Remove from Course</div></a>
